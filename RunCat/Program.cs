// Copyright 2025 StarryLibra, 2020 Takuto Nakamura
// 
...
public class RunCatApplicationContext : ApplicationContext
{
    ...
    public RunCatApplicationContext()
    {
        ...
        cpuUsage = new("Processor Information", "% Processor Utility", "_Total");
        _ = cpuUsage.NextValue();   // discards first return value

        runnerMenu = new("Runner", null,
        [
        ...
        runnerSpeedLimit = new("Runner Speed Limit", null,
        [
        ...
        notifyIcon.DoubleClick += new(HandleDoubleClick);
    ...
    {
        if (!string.IsNullOrEmpty(manualTheme))
        {
            SetIcons();
            return;
        }
    ...
    {
        animateTimer.Stop();
        animateTimer.Interval = speed.Equals("default") ? (int)interval : (int)Math.Max(minCPU, interval);
        animateTimer.Start();
    }
